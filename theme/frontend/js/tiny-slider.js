var tns = (function () {
  ...
  var aa = function (H) {
    ...
    if (
      ...
      var _,
        ...
        re = {
          ...
          keydown: function (t) {
            ...
            0 <= e &&
              (0 === e ? Ae.disabled || fi(t, -1) : Ne.disabled || fi(t, 1));
          },
        },
        oe = {
          click: function (t) {
      ...
      if (he)
        var Fe,
          ...
          Ge,
          Qe,
          Xe = "forward" === H.autoplayDirection ? 1 : -1,
          Ye = H.autoplayButton,
          ...
          F &&
            (g || rt
              ? (Wi(
                  Bt,
                  "#" + $t + " > .tns-item",
                  "font-size:" + m.getComputedStyle(Y[0]).fontSize + ";",
                  qi(Bt)
                ),
                Wi(Bt, "#" + $t, "font-size:0;", qi(Bt)))
              : I &&
                Fi(Y, function (t, e) {
                  var n;
                  t.style.marginLeft =
            ...
            for (var a in k) {
              ...
              x &&
                ...
                ("fixedWidth" in r ||
                  ...
                  (s += yn(f, h, c)),
                "gutter" in r && (s += gn(h)),
                !I && "speed" in r && (x && (s += bn(d)), b && (s += Cn(d))),
                s && (s = "#" + $t + " > .tns-item{" + s + "}"),
                (i = o + u + l + s) &&
                  Bt.insertRule(
      ...
      var nn = yt
          ? I
            ...
            : function () {
                if (Qt < jt) for (; Gt + K <= jt; ) jt -= K;
                else if (jt < Gt) for (; jt <= Qt - K; ) jt += K;
              }
          : function () {
        ...
        Fi(t, function (t) {
          ...
          St ||
            (e && e.indexOf("data:image") < 0
              ? ((t.src = ""), ea(t, be), Vi(t, "loading"), (t.src = e))
              : Wn(t));
        }),
          Hi(function () {
            Vn(Ji(t), function () {
    ...
    function En() {
      ...
      if (ve) {
        if (He)
          Yi(He, { "aria-label": "Carousel Pagination" }),
          ...
          for (
            var e = "", n = pe ? "" : 'style="display:none"', i = 0;
            i < K;
            i++
          )
            e +=
        ...
        Yi(Se[Ie], { "aria-label": We + (Ie + 1) + qe }),
          Ki(Se[Ie], "tabindex"),
          Vi(Se[Ie], ze),
          ea(He, oe);
      }
      de &&
        ...
        (Ae && Ne) || ((Ae = Te.children[0]), (Ne = Te.children[1])),
        H.controlsContainer &&
          Yi(Te, { "aria-label": "Carousel Navigation", tabindex: "0" }),
        (H.controlsContainer || (H.prevButton && H.nextButton)) &&
          Yi([Ae, Ne], { "aria-controls": $t, tabindex: "-1" }),
        (H.controlsContainer || (H.prevButton && H.nextButton)) &&
          (Yi(Ae, { "data-controls": "prev" }),
          Yi(Ne, { "data-controls": "next" })),
        (we = Un(Ae)),
        (Me = Un(Ne)),
        $n(),
        Te ? ea(Te, re) : (ea(Ae, re), ea(Ne, re))),
        Hn();
    }
    function An() {
      if (I && C) {
      ...
      wt && ea(G, ce, H.preventScrollOnTouch),
        ...
        pt && ea(O, se),
        "inner" === R
          ? _t.on("outerResized", function () {
              Ln(), _t.emit("innerLoaded", Si());
            })
          : (k || ot || rt || gt || !F) && ea(m, { resize: Nn }),
      ...
      if (U) {
        ...
        if (
          ...
          e &&
            ...
            (At = pn("autoplayText")),
            (Et = pn("autoplayTimeout")),
            D || ((ut = pn("edgePadding")), (lt = pn("gutter")))),
          rn(te),
          (st = dn()),
          (F && !rt) || te || (Yn(), F || (Ni(), (i = !0))),
          (ot || rt) && ((It = ni()), (Qt = Ft())),
          ...
          if (
            ...
            xt && bt !== w && ((Ae.innerHTML = bt[0]), (Ne.innerHTML = bt[1])),
            Ye && At !== T)
          ) {
            var N = Tt ? 1 : 0,
              L = Ye.innerHTML,
            ...
            L.substring(B) === T[N] &&
              (Ye.innerHTML = L.substring(0, B) + At[N]);
          }
        } else ct && (ot || rt) && (i = !0);
        if (
          ((r || (ot && !rt)) && ((De = Li()), Bi()),
          (a = jt !== x)
            ? (_t.emit("indexChanged", Si()), (i = !0))
            : r
            ? a || Gn()
            : (ot || rt) && (zn(), Kn(), Rn()),
          r &&
          ...
          if (
            ...
            !D &&
            ((ut === A && lt === E) ||
              (V.style.cssText = hn(ut, lt, ot, ht, gt)),
            F)
          ) {
    ...
    function Bn() {
      ...
      var t = ot ? (ot + lt) * K : _[K],
        e = ut ? st + 2 * ut : st + lt;
      return (
        ct && (e -= ot ? (st - ot) / 2 : (st - (_[jt + 1] - _[jt] - lt)) / 2),
        t <= e
      );
    }
    function Sn() {
    ...
    function Hn() {
      !Tt && Ye && Ui(Ye),
        !Ct && He && Ui(He),
        xt || (Te ? Ui(Te) : (Ae && Ui(Ae), Ne && Ui(Ne)));
    }
    function On() {
      Tt && Ye && _i(Ye),
        Ct && He && _i(He),
        xt && (Te ? _i(Te) : (Ae && _i(Ae), Ne && _i(Ne)));
    }
    function Dn() {
      if (!ae) {
        if ((ut && (V.style.margin = "0px"), Dt))
          for (var t = "tns-transparent", e = Dt; e--; )
            I && Vi(Y[e], t), Vi(Y[kt - e - 1], t);
        Hn(), (ae = !0);
      }
    }
    function kn() {
      ...
      zn(),
        ...
        (function () {
          if (Ct && ((Ie = 0 <= Re ? Re : sn()), (Re = -1), Ie !== Pe)) {
            var t = Se[Pe],
              e = Se[Ie];
            Yi(t, { tabindex: "-1", "aria-label": We + (Pe + 1) }),
              Gi(t, ze),
              Yi(e, { "aria-label": We + (Ie + 1) + qe }),
              Ki(e, "tabindex"),
              Vi(e, ze),
              (Pe = Ie);
          }
    ...
    function Kn() {
      ...
      Fi(Y, function (t, e) {
        n <= e && e <= i
          ? Qi(t, "aria-hidden") &&
            (Ki(t, ["aria-hidden", "tabindex"]), Vi(t, ge))
          : Qi(t, "aria-hidden") ||
            (Yi(t, { "aria-hidden": "true", tabindex: "-1" }), Gi(t, ge));
      });
    }
    function Jn(t) {
    ...
    function ni() {
      ...
      return (
        ct &&
          !yt &&
          (t = ot ? -(ot + lt) * (kt - 1) - ei() : ei(kt - 1) - _[kt - 1]),
        0 < t && (t = 0),
        t
      );
    }
    ...
    function si(t) {
      if (I || Jt) {
        ...
        if (
          ...
          (t.target === G && li(t.propertyName) === li(zt))
        ) {
          if (!Pt) {
            var i = jt;
    ...
    function Ti(t) {
      ...
      _t.emit(Ci(t) ? "touchStart" : "dragStart", Si(t)),
        ...
        ($e.x = Ze.x = e.clientX),
        ($e.y = Ze.y = e.clientY),
        I && ((Ue = parseFloat(G.style[zt].replace(Wt, ""))), ti(G, "0s"));
    }
    function Ei(t) {
      if (tn) {
        var e = xi(t);
              ...
              (_e = Hi(function () {
                !(function t(e) {
                  ...
                  if (Kt) {
                    ...
                    try {
                      e.type &&
                        _t.emit(Ci(e) ? "touchMove" : "dragMove", Si(e));
                    } catch (t) {}
                    var n = Ue,
                      i = en($e, Ze);
                    if (!F || ot || rt) (n += i), (n += "px");
